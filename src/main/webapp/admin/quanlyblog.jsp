        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Thêm Blog</span></a>
<%--                        <a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Xóa</span></a>--%>
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    <td>${i.idBlog}</td>
                    <td>${i.nameBlog}</td>
                    <td><img src="${i.pictureBlog}" style="height: 110px;width: 110px"></td>
                    <td>${i.dateBlog}</td>
                    <td>
                        <a href="LoadBlogDetail?idBlog=${i.idBlog}"  class="edit" ><i class="material-icons"  title="Edit">&#xE254;</i></a>
                        <a href="DeleteBlog?idB=${i.idBlog}" class="delete" ><i class="material-icons"  title="Delete">&#xE872;</i></a>
                    </td>
                </tr>
                </c:forEach>
                </tbody>
            ...
            <form action="AddBlog" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="20" cols="20" id="editor" name="content"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <a href="ManagerBlog"><input type="button" class="btn btn-default" data-dismiss="modal" value="Thoát"></a>
